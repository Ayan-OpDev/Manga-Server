...
mangaRouter.get('/search', async (c) => {
    ...
    try {
        ...
        return c.json({ success: false, error: 'Search failed', message: error.message }, 500);
    }
});
...
mangaRouter.get('/popular', async (c) => {
    ...
    try {
        ...
        return c.json({ success: false, error: 'Failed to fetch popular manga', message: error.message }, 500);
    }
});
// Latest Releases
mangaRouter.get('/latest', async (c) => {
    ...
    try {
        ...
        return c.json({ success: false, error: 'Failed to fetch latest manga', message: error.message }, 500);
    }
});
// Manga Info
mangaRouter.get('/manga/:id', async (c) => {
    ...
    try {
        ...
        return c.json({ success: false, error: 'Failed to fetch manga info', message: error.message }, 500);
    }
});
// Chapter List
mangaRouter.get('/chapters/:id', async (c) => {
    ...
    try {
        ...
        return c.json({ success: false, error: 'Failed to fetch chapters', message: error.message }, 500);
    }
});
// Chapter Pages
mangaRouter.get('/pages/:chapterId', async (c) => {
    ...
    try {
        ...
        return c.json({ success: false, error: 'Failed to fetch chapter pages', message: error.message }, 500);
    }
});
